...
class TestElevation(unittest.TestCase):
    ...
    def test_elevation_03(self):
        self.assertEqual(
            ...
            [{'elev_low': 0, 'elev_high': 2000, 'elev_units': 'ft',
    ...
    def test_elevation_06(self):
        self.assertEqual(
            ...
            [{'elev_low': 0, 'elev_high': 3000, 'elev_units': 'ft',
    ...
    def test_elevation_19(self):
        self.assertEqual(
            ...
            [{'elev_low': 2000, 'elev_high': 3000, 'elev_units': 'ft',
              'trait': 'elevation', 'start': 0, 'end': 8}]
        )
