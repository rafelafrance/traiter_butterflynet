...
class TestElevation(unittest.TestCase):
    ...
    def test_elevation_04(self):
        self.assertEqual(
            ...
            [{'elev_low': 0, 'elev_high': 200, 'elev_approx': True,
    ...
    def test_elevation_05(self):
        self.assertEqual(
            ...
            [{'elev_high': 1524, 'trait': 'elevation', 'start': 16, 'end': 23}]
        )

    def test_elevation_06(self):
        self.assertEqual(
            test_traits('sea level to 3000 ft'),
            [{'elev_low': 0, 'elev_high': 914,
    ...
    def test_elevation_07(self):
        self.assertEqual(
            ...
            [{'elev_high': 1500, 'trait': 'elevation', 'start': 18, 'end': 24}]
        )
    ...
    def test_elevation_08(self):
        self.assertEqual(
            ...
            [{'elev_high': 1250, 'trait': 'elevation', 'start': 18, 'end': 100}]
        )

    def test_elevation_09(self):
        self.assertEqual(
            test_traits('up to 500 m'),
            [{'elev_low': 0, 'elev_high': 500,
    ...
    def test_elevation_11(self):
        self.assertEqual(
            ...
            [{'elev_low': 0, 'elev_high': 1000, 'elev_approx': True,
    ...
    def test_elevation_12(self):
        self.assertEqual(
            ...
            [{'elev_low': 0, 'elev_high': 950, 'elev_approx': True,
    ...
    def test_elevation_14(self):
        self.assertEqual(
            test_traits('< 1800 m'),
            [{'elev_low': 0, 'elev_high': 1800, 'elev_approx': True,
    ...
    def test_elevation_15(self):
        self.assertEqual(
            test_traits('>1500m'),
            [{'elev_low': 1500, 'elev_approx': True,
    ...
    def test_elevation_17(self):
        self.assertEqual(
            test_traits('~1,500 m'),
            [{'elev_high': 1500, 'elev_approx': True,
              'trait': 'elevation', 'start': 0, 'end': 8}]
        )
    ...
    def test_elevation_18(self):
        self.assertEqual(
            ...
            [{'elev_low': 1400, 'elev_high': 2500, 'elev_units_inferred': True,
    ...
    def test_elevation_23(self):
        self.assertEqual(
            ...
            [{'elev_low': 2438,  'trait': 'elevation', 'start': 0, 'end': 19}]
        )
