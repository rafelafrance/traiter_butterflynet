...
class TestDimorphism(unittest.TestCase):
    ...
    def test_dimorphism_01(self):
        self.assertEqual(
            parse('is sexually dimorphic and seasonally variable'),
    ...
    def test_dimorphism_02(self):
        self.assertEqual(
            parse('Sexual dimorphism not prominent.'),
    ...
    def test_dimorphism_03(self):
        self.assertEqual(
            parse('sexual dimorphism is often pronounced'),
    ...
    def test_dimorphism_04(self):
        self.assertEqual(
            parse('Marked sexual dimorphism occurs in some genera'),
    ...
    def test_dimorphism_05(self):
        self.assertEqual(
            parse('Acraea adults exhibit little sexual dimorphism.'),
    ...
    def test_dimorphism_09(self):
        self.assertEqual(
            parse('Sexual dimorphism is not pronounced'),
    ...
    def test_dimorphism_10(self):
        self.assertEqual(
            parse('Sexual dimorphism present.'),
    ...
    def test_dimorphism_11(self):
        self.assertEqual(
            parse('There is no conspicuous sexual dimorphism,'),
    ...
    def test_dimorphism_13(self):
        self.assertEqual(
            parse(shorten("""Algiachroa adults are slightly dimorphic,""")),
    ...
    def test_dimorphism_16(self):
        self.assertEqual(
            parse(shorten("""Sexual dimorphism weakly recognizable.""")),
    ...
    def test_dimorphism_17(self):
        self.assertEqual(
            parse(shorten("""Sexual dimorphism absent.""")),
    ...
    def test_dimorphism_18(self):
        self.assertEqual(
            parse(shorten("""Sexual dimorphism: Not observed.""")),
    ...
    def test_dimorphism_21(self):
        self.assertEqual(
            parse(shorten("""Sexual dimorphism: Almost none;""")),
    ...
    def test_dimorphism_27(self):
        self.assertEqual(
            parse(shorten("""hind wing and sexes are similar""")),
    ...
    def test_dimorphism_28(self):
        self.assertEqual(
            parse(shorten("""The abdomen in both sexes is orange""")),
            []
        )

    def test_dimorphism_29(self):
        self.assertEqual(
            parse(shorten("""hind wing and sexes are different""")),
    ...
    def test_dimorphism_30(self):
        self.assertEqual(
            parse(shorten("""Sexes: dissimilar;""")),
    ...
    def test_dimorphism_31(self):
        self.assertEqual(
            parse(shorten("""The sexes are very similar,""")),
    ...
    def test_dimorphism_32(self):
        self.assertEqual(
            parse(shorten("""female resembles the male""")),
    ...
    def test_dimorphism_33(self):
        self.assertEqual(
            parse(shorten("""The females are similar to the males.""")),
    ...
    def test_dimorphism_34(self):
        self.assertEqual(
            parse(shorten("""The female is much larger than the male.""")),
    ...
    def test_dimorphism_35(self):
        self.assertEqual(
            parse(shorten("""Both sexes fly high in the canopy""")),
            []
        )
    ...
    def test_dimorphism_37(self):
        self.assertEqual(
            parse(shorten("""While seasonal dimorphism as such""")),
            []
        )

    def test_dimorphism_38(self):
        self.assertEqual(
            parse(shorten("""The female sex resembles that of both A.""")),
            []
        )
