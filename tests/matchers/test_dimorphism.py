...
class TestDimorphism(unittest.TestCase):
    ...
    def test_dimorphism_01(self):
        self.assertEqual(
            test('is sexually dimorphic and seasonally variable'),
    ...
    def test_dimorphism_02(self):
        self.assertEqual(
            test('Sexual dimorphism not prominent.'),
    ...
    def test_dimorphism_03(self):
        self.assertEqual(
            test('sexual dimorphism is often pronounced'),
    ...
    def test_dimorphism_04(self):
        self.assertEqual(
            test('Marked sexual dimorphism occurs in some genera'),
    ...
    def test_dimorphism_05(self):
        self.assertEqual(
            test('Acraea adults exhibit little sexual dimorphism.'),
    ...
    def test_dimorphism_09(self):
        self.assertEqual(
            test('Sexual dimorphism is not pronounced'),
    ...
    def test_dimorphism_10(self):
        self.assertEqual(
            test('Sexual dimorphism present.'),
    ...
    def test_dimorphism_11(self):
        self.assertEqual(
            test('There is no conspicuous sexual dimorphism,'),
    ...
    def test_dimorphism_16(self):
        self.assertEqual(
            test("""Sexual dimorphism weakly recognizable."""),
    ...
    def test_dimorphism_18(self):
        self.assertEqual(
            test("""Sexual dimorphism: Not observed."""),
    ...
    def test_dimorphism_21(self):
        self.assertEqual(
            test("""Sexual dimorphism: Almost none;"""),
    ...
    def test_dimorphism_26(self):
        self.assertEqual(
            test("""Both sexes vary considerably in size."""),
    ...
    def test_dimorphism_27(self):
        self.assertEqual(
            test("""hind wing and sexes are similar"""),
    ...
    def test_dimorphism_28(self):
        self.assertEqual(
            test("""The abdomen in both sexes is orange"""),
            []
        )

    def test_dimorphism_29(self):
        self.assertEqual(
            test("""hind wing and sexes are different"""),
    ...
    def test_dimorphism_31(self):
        self.assertEqual(
            test("""The sexes are very similar,"""),
    ...
    def test_dimorphism_32(self):
        self.assertEqual(
            test("""female resembles the male"""),
    ...
    def test_dimorphism_33(self):
        self.assertEqual(
            test("""The females are similar to the males."""),
    ...
    def test_dimorphism_35(self):
        self.assertEqual(
            test("""Both sexes fly high in the canopy"""),
            []
        )

    def test_dimorphism_36(self):
        self.assertEqual(
            test("""While seasonal dimorphism as such"""),
            []
        )
